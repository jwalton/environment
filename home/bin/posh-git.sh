# Modified version of posh-git which can be run from starship

# bash/zsh git prompt support
# From https://github.com/lyze/posh-git-sh
#
...
__posh_git_echo () {
    ...
    local DefaultForegroundColor=$(__posh_color '\033[0m') # Default no color
